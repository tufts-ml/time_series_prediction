...
from CNNBinaryClassifierModule import CNNBinaryClassifierModule

class CNNBinaryClassifier(skorch.NeuralNet):
    ...
    def __init__(
        ...
        self.clip = clip
        kwargs.update(module=CNNBinaryClassifierModule)
