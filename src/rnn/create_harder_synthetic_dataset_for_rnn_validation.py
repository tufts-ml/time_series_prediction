...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed', type=int, default=1111,
                        help='random seed')
    parser.add_argument('--save_dir', type=str, default='simulated_data/3-state/',
...
#     from IPython import embed; embed()
    ...
    axs[0].set_title('Example with No State Transition from A to B : (Label 0)', fontsize = fontsize)
    ...
    axs[2].set_title('Example with State Transition from A to B : (Label 1)', fontsize = fontsize)
    ...
    f.savefig(fdir_train_test + '/harder_simulated_data.png')
#     from IPython import embed; embed()