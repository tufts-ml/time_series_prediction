...
#             bin_length = 192
            ...
            for bin_ind in range(len(timestamp_bins)-1):
                ...
                if len(curr_bin_split_features_df)>0:
                    ...
                    if bin_ind==0:
                        ...
                        skorch_lr_bce = SkorchLogisticRegression(n_features=x_split.shape[1])
                    ...
                    for loss_name, model_clf in [('cross_entropy_loss', skorch_lr_bce)]:
            ...
            axs_list[0].tick_params(axis='x', rotation=45)
            ...
            plt.suptitle('Prospective Evaluation of Alarm Counts with Logistic Regression on %s Set \n (Start date : %s, End date : %s)'%(split.capitalize(),
                                                                                                             first_admission_timestamp,
                                                                                                             last_admission_timestamp),
                         fontsize=22)
            f.savefig('skorch_lr_%s_alarm_distributions.png'%split)
