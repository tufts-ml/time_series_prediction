...
#             print('tslice: %s, auroc_test : %.2f'%(tslice, auroc_test_final))
        ...
        if p==0:
            ...
            rnn.initialize()
            rnn.load_params(f_params=os.path.join(args.clf_models_dir,
                                          'hiddens=128-layers=2-lr=0.0025-dropout=0-weight_decay=0.0001params.pt'),
                    f_optimizer=os.path.join(args.clf_models_dir,
                                             'hiddens=128-layers=2-lr=0.0025-dropout=0-weight_decay=0.0001optimizer.pt'),
                    f_history=os.path.join(args.clf_models_dir,
