...
$ snakemake --cores 1 --snakefile rnn_per_tstep_custom_times.smk train_and_evaluate_classifier_many_hyperparams
'''
...
RESULTS_FEAT_PER_TSTEP_PATH = os.path.join(RESULTS_FEAT_PER_TSTEP_PATH, 'CustomTimes', 'rnn_per_tstep')
