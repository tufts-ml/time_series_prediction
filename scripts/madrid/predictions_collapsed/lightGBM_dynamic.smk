...
rule train_and_evaluate_classifier_many_hyperparams:
    input:
        [os.path.join(RESULTS_COLLAPSED_FEAT_DYNAMIC_INPUT_OUTPUT_PATH, "lightGBM_min_samples_per_leaf={min_samples_per_leaf}-max_leaves={max_leaves}-n_estimators={n_estimators}-frac_features_for_clf={frac_features_for_clf}-frac_training_samples_per_tree={frac_training_samples_per_tree}_perf.csv").format(min_samples_per_leaf=min_samples_per_leaf, max_leaves=max_leaves, n_estimators=n_estimators, frac_training_samples_per_tree=frac_training_samples_per_tree, frac_features_for_clf=frac_features_for_clf) for min_samples_per_leaf in config['min_samples_per_leaf'] for max_leaves in config['max_leaves'] for n_estimators in config['n_estimators'] for frac_features_for_clf in config['frac_features_for_clf'] for frac_training_samples_per_tree in config['frac_training_samples_per_tree']]
...
rule train_and_evaluate_classifier:
    ...
    params:
        ...
        fn_prefix="lightGBM_min_samples_per_leaf={min_samples_per_leaf}-max_leaves={max_leaves}-n_estimators={n_estimators}-frac_features_for_clf={frac_features_for_clf}-frac_training_samples_per_tree={frac_training_samples_per_tree}"

    output:
        os.path.join(RESULTS_COLLAPSED_FEAT_DYNAMIC_INPUT_OUTPUT_PATH, "lightGBM_min_samples_per_leaf={min_samples_per_leaf}-max_leaves={max_leaves}-n_estimators={n_estimators}-frac_features_for_clf={frac_features_for_clf}-frac_training_samples_per_tree={frac_training_samples_per_tree}_perf.csv")
