'''
>> snakemake --cores 1 --snakefile evaluate_pchmm_pertslice_performance.smk evaluate_performance
'''
...
rule evaluate_performance:
    input:
        script=os.path.join(os.path.abspath('../'), "src", "evaluate_pchmm_pertslice_performance.py")
