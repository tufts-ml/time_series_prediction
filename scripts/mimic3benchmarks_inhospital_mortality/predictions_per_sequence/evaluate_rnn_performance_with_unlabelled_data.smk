'''
>> snakemake --cores 1 --snakefile evaluate_rnn_performance_with_unlabelled_data.smk evaluate_performance
'''
...
rule evaluate_performance:
    input:
        script=os.path.join(os.path.abspath('../'), "src", "evaluate_rnn_performance_with_unlabelled_data.py")
