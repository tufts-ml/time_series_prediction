'''
>> snakemake --cores 1 --snakefile evaluate_fully_supervised_pchmm_performance.smk evaluate_performance
'''
...
rule evaluate_performance:
    input:
        script=os.path.join(os.path.abspath('../'), "src", "evaluate_fully_supervised_pchmm_performance.py")
