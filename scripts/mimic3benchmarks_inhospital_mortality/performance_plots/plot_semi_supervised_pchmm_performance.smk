...
>> snakemake --cores 1 --snakefile plot_semi_supervised_pchmm_performance.smk plot_first_24_hours_performance 
'''
import glob
import os
import sys
...
rule plot_first_24_hours_performance:
    input:
        script=os.path.abspath('../src/plot_semi_supervised_pchmm_first_24_hrs_performance.py')
