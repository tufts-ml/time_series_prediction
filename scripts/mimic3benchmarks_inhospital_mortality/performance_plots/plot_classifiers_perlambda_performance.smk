...
>> snakemake --cores 1 --snakefile plot_classifiers_perlambda_performance.smk plot_first_24_hours_performance 
'''
import glob
import os
import sys
...
rule plot_first_24_hours_performance:
    input:
        script=os.path.abspath('../src/plot_pchmm_perlambda_first_24_hrs_performance.py')
