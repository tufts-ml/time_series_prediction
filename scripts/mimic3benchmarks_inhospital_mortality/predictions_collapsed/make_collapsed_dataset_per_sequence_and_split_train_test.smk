...
snakemake --cores 1 --snakefile make_collapsed_dataset_per_sequence_and_split_train_test.smk collapse_features_many_tslices

# merge the collapsed features for training tslices mentioned in config file
snakemake --cores 1 --snakefile make_collapsed_dataset_per_sequence_and_split_train_test.smk merge_collapsed_features_all_tslices
