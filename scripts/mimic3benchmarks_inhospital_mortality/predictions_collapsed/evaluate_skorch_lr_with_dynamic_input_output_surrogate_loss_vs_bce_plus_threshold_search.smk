...
----------------------------------------------------------------------------------------------------------------------------
>> snakemake --cores 1 --snakefile evaluate_skorch_lr_with_dynamic_input_output_surrogate_loss_vs_bce_plus_threshold_search.smk evaluate_performance
'''
...
RESULTS_COLLAPSED_FEAT_DYNAMIC_INPUT_OUTPUT_PATH="/cluster/tufts/hugheslab/prath01/results/mimic3/collapsed_features_dynamic_input_output/skorch_logistic_regression"
