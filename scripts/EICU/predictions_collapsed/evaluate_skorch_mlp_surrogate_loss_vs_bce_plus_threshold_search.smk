...
----------------------------------------------------------------------------------------------------------------------------
>> snakemake --cores 1 --snakefile evaluate_skorch_mlp_surrogate_loss_vs_bce_plus_threshold_search.smk evaluate_performance
'''
...
RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH="/cluster/tufts/hugheslab/prath01/results/eicu/skorch_mlp"
