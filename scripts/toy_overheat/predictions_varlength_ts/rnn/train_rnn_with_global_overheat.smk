...
$ snakemake --cores all --snakefile train_rnn_with_global_overheat.smk train_and_evaluate_classifier_many_hyperparams
'''
...
rule train_and_evaluate_classifier:
    ...
    params:
        ...
        fn_prefix="rnn-global-hiddens={hidden_units}-layers={hidden_layers}-lr={lr}-dropout={dropout}-weight_decay={weight_decay}-batch_size={batch_size}"
    
    output:
        os.path.join(RESULTS_FEAT_PER_TSTEP_PATH, "rnn-global-hiddens={hidden_units}-layers={hidden_layers}-lr={lr}-dropout={dropout}-weight_decay={weight_decay}-batch_size={batch_size}.json")
