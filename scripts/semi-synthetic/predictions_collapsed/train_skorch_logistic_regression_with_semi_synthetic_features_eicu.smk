...
Usage
-----
snakemake --cores 1 --snakefile train_skorch_logistic_regression_with_semi_synthetic_features_eicu.smk train_and_evaluate_classifier_many_hyperparams

snakemake --snakefile train_skorch_logistic_regression_with_semi_synthetic_features_eicu.smk --profile ../../../profiles/hugheslab_cluster/ train_and_evaluate_classifier_many_hyperparams

'''

configfile : "skorch_logistic_regression_semi_synthetic.json"

PROJECT_REPO_DIR = "/cluster/tufts/hugheslab/prath01/projects/time_series_prediction/"
SEMI_SYNTHETIC_DATA_PATH = "/cluster/tufts/hugheslab/prath01/projects/time_series_prediction/datasets/semi_synthetic_precision_recall_eicu/"

RESULTS_SEMI_SYNTHETIC_PATH="/cluster/tufts/hugheslab/prath01/results/semi-synthetic_eicu/skorch_logistic_regression"
