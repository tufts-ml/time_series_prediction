...
Usage
-----
snakemake --cores 1 --snakefile train_logistic_regression_with_per_sequence_features.smk train_and_evaluate_classifier
...
RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH = os.path.join(RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH, 'logistic_regression')
...
rule train_and_evaluate_classifier:
    ...
    output:
        output_html=os.path.join(RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH, "report.html")
