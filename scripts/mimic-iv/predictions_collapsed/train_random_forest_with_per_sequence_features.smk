...
Usage
-----
snakemake --cores 1 --snakefile train_random_forest_with_per_sequence_features.smk train_and_evaluate_classifier
...
RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH = os.path.join(RESULTS_COLLAPSED_FEAT_PER_SEQUENCE_PATH, 'random_forest')
